...
<body class="logado-tela-fundo">
    ...
    <div class="novo-frete">
      ...
      <section class="novo-frete-conteudo">
        <h3 class="login-conteudo-titulo vermelho"><strong>Atualize as informações do frete!</strong></h3>
        <form class="login-formulario" method="POST" action="frete_controller.php?acao=atualizar">
          ...
          <?php foreach($frete as $user => $frete) { ?>
            ...
            <div class="login-formulario-barra">
                ...
                <input class="login-conteudo-input cinza" type="text" placeholder="Título do frete" name="titulo" value="<?= $frete->titulo?>" required>
            </div>
            ...
            <div class="login-formulario-barra">
                ...
                <select name="tp_caminhao" class="login-conteudo-input cinza">
                  <option value="" disabled selected><?= $frete->tp_caminhao?></option>
            ...
            <div class="login-formulario-barra">
                ...
                <input class="login-conteudo-input cinza" type="text" placeholder="Peso da carga" name="peso_carga"  value="<?= $frete->peso_carga?>" required>
            </div>

            <div class="login-formulario-barra">
                <img class="icone" alt="Local coleta" src="img/icons/local-coleta.svg">
                <input class="login-conteudo-input cinza" type="text" placeholder="Local de coleta, ex: endereço, número, bairro, cidade e estado" name="local_coleta" value="<?=$frete->local_coleta?>" required>
            </div>

            <div class="login-formulario-barra">
                <img class="icone" alt="Local destino" src="img/icons/local-destino.svg">
                <input class="login-conteudo-input cinza" type="text" placeholder="Local do destino, ex: endereço, número, bairro, cidade e estado" name="local_entrega" value="<?=$frete->local_entrega?>" required>
            </div>
